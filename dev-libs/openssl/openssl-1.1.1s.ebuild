...
IUSE="+asm bindist rfc3779 sctp cpu_flags_x86_sse2 sslv3 static-libs test tls-compression tls-heartbeat vanilla verify-sig weak-ssl-ciphers"
RESTRICT="!test? ( test )"
...
multilib_src_configure() {
	...
	CFLAGS= LDFLAGS= ./${config} "${myeconfargs[@]}"
